     ...
     <nav className="navbar navbar-expand-md fixed-top bg-light" data-bs-theme="light" style={{ marginBottom: '250px' }}>
        <div className="container">
          <NavLink to='/' end className="navbar-brand">
            <img src="https://cdn-icons-png.freepik.com/512/1307/1307275.png" alt="Logo" width="40" height="40" style={{ padding: '0', margin: '0', borderRadius: '0.370rem' }} />
          </NavLink>
          ...
          <div className="navbar-collapse" id="navbarTogglerDemo02">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <NavLink to='/documents' end className="nav-link hover:bg-blue-100 text-black font-bold" aria-current="page">Documents</NavLink>
              </li>
              {user?.data.user.role !== 'USER' && <li className="nav-item">
                <NavLink to='/users' end className="nav-link hover:bg-blue-100 text-black font-bold">Users</NavLink>
              </li>}
            </ul>
            <div className="flex-shrink-0 dropdown">
              <a className="d-block link-body-emphasis text-decoration-none profile-dropdown" style={{cursor: 'pointer'}}
